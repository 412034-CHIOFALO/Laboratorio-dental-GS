package com.gys.ms_catalogo.exception.handler;

import com.gys.ms_catalogo.dto.ErrorResponse;
import com.gys.ms_catalogo.exception.BusinessException;
import com.gys.ms_catalogo.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        log.warn("[GYS-CATALOGO] Violación de integridad de datos en {}: {}", req.getRequestURI(), ex.getMostSpecificCause().getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest req) {
        log.error("[GYS-CATALOGO] Error inesperado en {}: {}", req.getRequestURI(), ex.getMessage(), ex);
