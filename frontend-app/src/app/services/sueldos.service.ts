...
export type EstadoRegistroBot = 'REGISTRADO' | 'RECHAZADO' | 'DUPLICADO';
...
export interface RegistroBot {
  ...
  emisor: string | null;            // quién pagó (De)
  receptorNombre: string | null;    // a quién (Para, crudo)
  tipoReceptor: TipoReceptorBot | null;
  receptorId: number | null;
  receptorResuelto: string | null;  // nombre del empleado/proveedor resuelto
