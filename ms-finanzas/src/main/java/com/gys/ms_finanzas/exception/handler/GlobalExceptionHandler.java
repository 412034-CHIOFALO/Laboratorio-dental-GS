package com.gys.ms_finanzas.exception.handler;

import com.gys.ms_finanzas.dto.ErrorResponse;
import com.gys.ms_finanzas.exception.BusinessException;
import com.gys.ms_finanzas.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        log.warn("[GYS-FINANZAS] Violación de integridad de datos en {}: {}", req.getRequestURI(), ex.getMostSpecificCause().getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest req) {
        log.error("[GYS-FINANZAS] Error inesperado en {}: {}", req.getRequestURI(), ex.getMessage(), ex);
