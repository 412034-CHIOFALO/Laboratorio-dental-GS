...
/**
 * Agrega un set base de proveedores de insumos dentales al arrancar, para
 * tener con qué probar el flujo de deudas/pagos a proveedores. Mismo patrón
 * que el seed de stock y el de odontólogos de prueba: sin {@code @Profile},
 * corre en todos los ambientes porque en producción esta tabla arranca vacía.
 *
 * <p>Idempotente por nombre — si el laboratorio ya cargó proveedores propios
 * a mano, este seed no los duplica ni los pisa.</p>
 */
@Component
