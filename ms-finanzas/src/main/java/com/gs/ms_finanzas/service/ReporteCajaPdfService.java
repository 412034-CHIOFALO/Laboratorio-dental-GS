...
/**
 * Genera los reportes de caja en PDF (OpenPDF):
 * <ul>
 *   <li><b>Cierre diario</b>: movimientos del día por caja, con subtotales y saldos actuales.</li>
 *   <li><b>Resumen mensual</b>: totales de ingresos/egresos por caja y detalle del mes.</li>
 * </ul>
 * Los datos se toman del {@link ICajaService} (misma fuente que el panel web).
 */
@Service
...
public class ReporteCajaPdfService {
    ...
    // Paleta
    private static final Color TEAL   = new Color(15, 118, 110);   // encabezados
    ...
    /** PDF con el cierre de caja de un día: movimientos por caja, subtotales y saldos. */
    ...
    /** PDF con el resumen del mes: totales por caja + detalle de movimientos. */
    ...
    /** Celda de monto alineada a la derecha, coloreada según signo. */
