package com.gys.ms_stock.exception.handler;

import com.gys.ms_stock.dto.ErrorResponse;
import com.gys.ms_stock.exception.BusinessException;
import com.gys.ms_stock.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        log.warn("[GYS-STOCK] Violación de integridad de datos en {}: {}", req.getRequestURI(), ex.getMostSpecificCause().getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest req) {
        log.error("[GYS-STOCK] Error inesperado en {}: {}", req.getRequestURI(), ex.getMessage(), ex);
