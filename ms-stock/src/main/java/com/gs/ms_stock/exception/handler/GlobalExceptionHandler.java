package com.gs.ms_stock.exception.handler;

import com.gs.ms_stock.dto.ErrorResponse;
import com.gs.ms_stock.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        log.warn("[GS-STOCK] Violación de integridad de datos en {}: {}", req.getRequestURI(), ex.getMostSpecificCause().getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest req) {
        log.error("[GS-STOCK] Error inesperado en {}: {}", req.getRequestURI(), ex.getMessage(), ex);
