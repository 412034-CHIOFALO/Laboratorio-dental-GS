...
public class SecurityConfig {
     ...
     *
     * El client_id es "gys-frontend" y soporta:
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        RegisteredClient frontendClient = RegisteredClient.withId(UUID.randomUUID().toString())
            .clientId("gys-frontend")
            .clientSecret(passwordEncoder.encode("gys-frontend-secret"))
            ...
            .redirectUri("http://localhost:4200/login/oauth2/code/gys")
            .redirectUri("http://localhost/login/oauth2/code/gys")
