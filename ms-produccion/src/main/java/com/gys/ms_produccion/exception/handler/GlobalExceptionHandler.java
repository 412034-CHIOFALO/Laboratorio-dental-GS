package com.gys.ms_produccion.exception.handler;

import com.gys.ms_produccion.dto.ErrorResponse;
import com.gys.ms_produccion.exception.BusinessException;
import com.gys.ms_produccion.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest req) {
        log.warn("[GYS-PRODUCCION] Violación de integridad de datos en {}: {}", req.getRequestURI(), ex.getMostSpecificCause().getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest req) {
        log.error("[GYS-PRODUCCION] Error inesperado en {}: {}", req.getRequestURI(), ex.getMessage(), ex);
